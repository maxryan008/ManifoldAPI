...
public class ManifoldPackets {
    public static void registerC2SPackets() {
        ServerPlayNetworking.registerGlobalReceiver(BreakInConstructC2SPacket.TYPE, (payload, context) -> context.server().execute(() -> ConstructManager.INSTANCE.breakBlockInConstruct(payload, context)));
